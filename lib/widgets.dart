...
class AccentSelector extends StatefulWidget {
  AccentSelector({Key key}) : super(key: key);
  AccentSelectorState createState() => AccentSelectorState();
}

class AccentSelectorState extends State<AccentSelector> with TickerProviderStateMixin {
  bool _init = true;
