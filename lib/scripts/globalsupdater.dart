...
void updateGlobals(String languageRegion) {
  if (languageRegion == 'en_us') {
    ...
    Globals.STRING_SETTING_LANGUAGE_SUBTITLE                         = 'Change the way you see the app...';
    Globals.STRING_SETTING_LANGUAGE_RESTART_DIALOG_TITLE             = 'Information';
    Globals.STRING_SETTING_LANGUAGE_RESTART_DIALOG_SUBTITLE          = 'You have to restart the app to see changes.';
    ...
    Globals.STRING_ABOUT_TITLE                                       = 'बारे में';
    ...
    Globals.STRING_SETTING_SERVER_CHANGE_SERVER_HINT                 = 'कोई सर्वर URL दें';
    Globals.STRING_SETTING_SERVER_CHANGE_SERVER_LABEL                = 'सर्वर URL';
