...
void updateGlobals(String languageRegion) {
  if (languageRegion == 'en_us') {
    ...
    Globals.STRING_INTERNET_ERROR ='Überprüfen Sie bitte Ihre Internetverbindung...';
    ...
    Globals.STRING_NOW_PLAYING = 'Abspielen';
    ...
    Globals.STRING_SEARCH_MODE_SUBTITLE_ALBUM = 'Musik nach Alben durchsuchen';
    Globals.STRING_SEARCH_MODE_SUBTITLE_TRACK = 'Musik nach Song durchsuchen';
    Globals.STRING_SEARCH_MODE_SUBTITLE_ARTIST ='Musik von Ihren Lieblingskünstler suchen';
    Globals.STRING_SEARCH_HISTORY_SUBHEADER = 'Ihre letzten Suchen';
    Globals.STRING_SEARCH_RESULT_LOADER_LABEL = 'Musik wird durchsucht...';
    Globals.STRING_SEARCH_RESULT_TOP_SUBHEADER_ALBUM ='Hier ist das bestmögliche Album zu Ihrer Suche';
    Globals.STRING_SEARCH_RESULT_TOP_SUBHEADER_TRACK ='Hier ist der bestmögliche Song zu ihrer Suche';
    ...
    Globals.STRING_SEARCH_RESULT_TOP_BUTTON_LABEL_1_ALBUM = 'ALBUM';
    Globals.STRING_SEARCH_RESULT_TOP_BUTTON_LABEL_1_TRACK = 'SONGS';
    Globals.STRING_SEARCH_RESULT_TOP_BUTTON_LABEL_1_ARTIST = 'KÜNSTLER';
    Globals.STRING_SEARCH_RESULT_OTHER_SUBHEADER_ALBUM ='Mehr Alben zu dem Ergebnis';
    Globals.STRING_SEARCH_RESULT_OTHER_SUBHEADER_TRACK ='Mehr Songs zu dem Ergebnis';
    ...
    Globals.STRING_ALBUM_VIEW_DOWNLOAD_BACK_SUBTITLE ='Eine oder mehrere Songs werden offline gespeichert. Bitte warten Sie einen Moment, bis alle Songs gespeichert sind.';
    Globals.STRING_ALBUM_VIEW_DOWNLOAD_ERROR_NETWORK_TITLE ='Der Song konnte nicht gespeichert werden.';
    Globals.STRING_ALBUM_VIEW_DOWNLOAD_ERROR_NETWORK_SUBTITLE ='Bitte überprüfen Sie Ihre Internetverbindung und versuchen Sie es bitte erneut.';
    Globals.STRING_ALBUM_VIEW_DOWNLOAD_ERROR_RATE_TITLE ='Wir haben alle einmal schlechte Tage. :-(';
    ...
    Globals.STRING_ALBUM_VIEW_DOWNLOAD_ERROR_SAVING_SUBTITLE ='Speziell dieser Song konnte nicht gespeichert werden. Wir versuchen immer noch herauszufinden, was diesen Fehler verursacht. Bitte laden Sie in der Zwischenzeit einfach andere Musik herunter. Vielen Dank für Ihre freundliche Unterstützung!';
    Globals.STRING_ALBUM_VIEW_DOWNLOAD_DOUBLE_TITLE = 'einen Moment...';
    Globals.STRING_ALBUM_VIEW_DOWNLOAD_DOUBLE_SUBTITLE ='Dieser Song wird bereits heruntergeladen.';
    Globals.STRING_ALBUM_VIEW_LOADER_LABEL = 'Songs suchen...';
    Globals.STRING_ALBUM_VIEW_TRACKS_SUBHEADER = 'alle Songs zu diesem Album';
    ...
    Globals.STRING_LOCAL_ALBUM_VIEW_INFO_SUBHEADER = 'Einblicke in das Album';
    Globals.STRING_LOCAL_ALBUM_VIEW_ALBUM_DELETE_DIALOG_HEADER ='Dieses Album löschen ?';
    Globals.STRING_LOCAL_ALBUM_VIEW_ALBUM_DELETE_DIALOG_BODY ='Sind Sie sich sicher?';
    ...
    Globals.STRING_NOW_PLAYING_NOT_PLAYING_HEADER = 'Wir sind bereit...';
    Globals.STRING_SETTING_GITHUB = 'GITHUB';
    Globals.STRING_SETTING_STAR_GITHUB = 'PROJEKT MIT "STAR" VERSEHEN';
    Globals.STRING_SETTING_STARGAZERS_TITLE ='"Star"-Geber'; // i dont know what it mean in the App?
    ...
    Globals.STRING_SETTING_STARGAZERS_INFORMATION_ERROR ='Wir konnten die Informationen über die neuesten Sterngucker nicht abrufen.'; // i dont know what it mean in the App? (stargazer)
    Globals.STRING_SETTING_LANGUAGE_TITLE = 'Sprachen';
    Globals.STRING_SETTING_LANGUAGE_SUBTITLE ='Spracheinstellungen der App ändern';
    Globals.STRING_SETTING_LANGUAGE_RESTART_DIALOG_TITLE = 'Informationen';
    Globals.STRING_SETTING_LANGUAGE_RESTART_DIALOG_SUBTITLE ='Die App muss neugestartet werden, erst dann werden die Änderungen zu sehen sein.';
    Globals.STRING_ABOUT_TITLE = 'Über';
    Globals.STRING_ABOUT_SUBTITLE ='Informationen über die App und deren Entwickler';
    Globals.STRING_SETTING_SERVER_CHANGE_TITLE = 'Server';
    Globals.STRING_SETTING_SERVER_CHANGE_SUBTITLE ='Woher sollen die Lieder geladen werden?';
    Globals.STRING_SETTING_SERVER_CHANGE_SERVER_HINT ='Geben Sie eine gültige Server-URL ein';
    Globals.STRING_SETTING_SERVER_CHANGE_SERVER_LABEL = 'Server-URL';
    Globals.STRING_SETTING_SERVER_CHANGE_ERROR_INVALID ='Dies ist keine gültige Server-URL für diese App.';
    ...
    Globals.STRING_SETTING_SERVER_CHANGE_CHANGING ='Server wird für die App gewechselt...';
  }
}
