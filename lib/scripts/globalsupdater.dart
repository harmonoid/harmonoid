...
void updateGlobals(String languageRegion) {
  if (languageRegion == 'en_us') {
    ...
    Globals.STRING_NOW_PLAYING                                     = 'Läuft aktuell';
    ...
    Globals.STRING_SEARCH_MODE_SUBTITLE_TRACK                      = 'Suche nach Ihren Lieblingssongs';
    ...
    Globals.STRING_SEARCH_RESULT_LOADER_LABEL                      = 'suche Musik...';
    ...
    Globals.STRING_ALBUM_VIEW_DOWNLOAD_ERROR_SAVING_SUBTITLE       = 'Dieser Song konnte speziell nicht gespeichert werden. Wir versuchen immer noch herauszufinden, was diesen Fehler verursacht. Bitte laden Sie in der Zwischenzeit einfach andere Musik herunter. Vielen Dank für Ihre freundliche Unterstützung!';
    ...
    Globals.STRING_ALBUM_VIEW_TRACKS_SUBHEADER                     = 'Hier sind die Songs zu diesem Album';
    ...
    Globals.STRING_SETTING_STARGAZERS_TITLE                        = 'Projekt Sterngucker'; // i dont know what it mean in the App? 
    ...
    Globals.STRING_SETTING_SERVER_CHANGE_TITLE                     = 'Server';
    Globals.STRING_SETTING_SERVER_CHANGE_SUBTITLE                  = 'Ändern um anzupassen, woher die App ihre Daten zieht.';
