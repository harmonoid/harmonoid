...
final VLC.Player vlcplayer = new VLC.Player(id: 69420);
...
abstract class Playback {
  static Future<void> play(
    ...
    if (Platform.isAndroid || Platform.isIOS) {
      ...
      List<VLC.Media> audios = <VLC.Media>[];
      _tracks.forEach((Track track) {
        audios.add(
          VLC.Media.file(new File(track.filePath!)),
        );
      });
      vlcplayer.open(new VLC.Playlist(medias: audios));
    }
  }
}
