...
class KeyboardShortcuts {
  ...
  late final Map<ShortcutActivator, VoidCallback> bindings = {
    ...
    SingleActivator(LogicalKeyboardKey.keyF, control: control, meta: !control): MediaLibraryScreenState.desktopSearchQueryTextFieldFocusNode.requestFocus,
    SingleActivator(LogicalKeyboardKey.keyS, control: control, meta: !control): MediaLibraryScreenState.desktopSearchQueryTextFieldFocusNode.requestFocus,
