...
class AlbumScreenState extends State<AlbumScreen>
  ...
  bool fabsVisible = false;
  ScrollController controller = ScrollController();
  late AnimationController sliverAppBarDetailsHeightAnimationController;
  late Animation<double> sliverAppBarDetailsHeightAnimationValue;
  ...
  void initState() {
    ...
    if (isMobile) {
      this.sliverAppBarDetailsHeightAnimationController = AnimationController(
        vsync: this,
        duration: Duration(milliseconds: 200),
      );
      this.sliverAppBarDetailsHeightAnimationValue = Tween<double>(
        begin: 0.0,
        end: 136.0,
      ).animate(CurvedAnimation(
        parent: this.sliverAppBarDetailsHeightAnimationController,
        curve: Curves.easeInOut,
      ));
      Timer(Duration(milliseconds: 300), () {
        this.sliverAppBarDetailsHeightAnimationController.forward();
      ...
      this.controller.addListener(() {
        ...
        } else if (this.detailsVisible = true) {
          this.setState(() {
    ...
    return isDesktop
        ...
        : Scaffold(
            body: Stack(
              children: [
                AnimatedBuilder(
                  animation: this.sliverAppBarDetailsHeightAnimationController,
                  builder: (context, _) => CustomScrollView(
                    controller: this.controller,
                    slivers: [
                      SliverAppBar(
                        expandedHeight: MediaQuery.of(context).size.width +
                            this.sliverAppBarDetailsHeightAnimationValue.value -
                            MediaQuery.of(context).padding.top,
                        pinned: true,
                        leading: IconButton(
                              ...
                              TweenAnimationBuilder<double>(
                                ...
                                builder: (context, value, _) => Opacity(
                                  ...
                                  child: Container(
                                    color: this.color,
                                    height: this
                                        .sliverAppBarDetailsHeightAnimationValue
                                        .value,
                                    width: MediaQuery.of(context).size.width,
                                    padding: EdgeInsets.all(16.0),
                                    child: Column(
                        ...
                        delegate: SliverChildBuilderDelegate(
                          (context, i) => Material(
                            ...
                            child: InkWell(
                              onTap: () => Playback.play(
                                index: i,
                                tracks: widget.album.tracks + collection.tracks,
                              ),
                              onLongPress: () async {
                                var result;
                ...
                Positioned(
                  ...
                  child: TweenAnimationBuilder(
                    tween: Tween<double>(
                        begin: 0.0, end: this.fabsVisible ? 1.0 : 0.0),
                    duration: Duration(milliseconds: 200),
                    builder: (context, value, _) => Transform.scale(
                      scale: value as double,
                      child: Transform.rotate(
                        angle: (1.0 - value) * 2 * pi,
