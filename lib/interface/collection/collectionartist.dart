            ...
            delegate: SliverChildListDelegate(
              collection.tracks.isNotEmpty
                  ? tileGridListWidgets(
                      ...
                      leadingSubHeader:
                          language!.STRING_LOCAL_TOP_SUBHEADER_ARTIST,
            ...
            child: InkWell(
              child: Row(
                ...
                children: [
                  Ink.image(
                    image:
                        FileImage(collection.lastArtist!.tracks.last.albumArt),
                    fit: BoxFit.fill,
                    height: this.height,
                    width: this.height,
                  ),
...
class CollectionArtist extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Consumer<Collection>(
      ...
      builder: (context, collection, child) => this.artist!.tracks.length == 0
          ? Container()
                          ...
                          Stack(
                            ...
                            children: [
                              ...
                              Card(
                                margin: EdgeInsets.only(
                                  left:
                                      (MediaQuery.of(context).size.width - wh) /
                                          2,
                                  right:
                                      (MediaQuery.of(context).size.width - wh) /
                                          2,
