...
class CollectionPlaylist extends StatelessWidget {
  ...
  List<Widget> buildList(BuildContext context, collection) {
    List<Widget> widgets = [];
    int index = 0;
    ...
    return Consumer<Collection>(
      builder: (context, collection, _) => Scaffold(
        ...
        body: ReorderableListView(
            children: buildList(context, collection),
            onReorder: (int oldIndex, int newIndex) {
              print("onReorder called");
              collection.playlistReorder(playlist, oldIndex, newIndex);
              // This is basically a setState, but more complex
