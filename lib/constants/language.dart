...
class Language extends Strings with ChangeNotifier {
  ...
  Future<void> set({
    ...
    ALBUM_TILE_CUSTOMIZATION = map['ALBUM_TILE_CUSTOMIZATION']!;
    ...
    DISPLAY_ALBUM_CARD_TOP_RIGHT_DATE = map['DISPLAY_ALBUM_CARD_TOP_RIGHT_DATE']!;
    DISPLAY_ALBUM_CARD_TOP_RIGHT_DATE_SUBTITLE = map['DISPLAY_ALBUM_CARD_TOP_RIGHT_DATE_SUBTITLE']!;
    DISPLAY_AUDIO_FORMAT = map['DISPLAY_AUDIO_FORMAT']!;
    DISPLAY_THIRD_ITEM_IN_ROW_IN_TRACK_TILE = map['DISPLAY_THIRD_ITEM_IN_ROW_IN_TRACK_TILE']!;
    DISPLAY_THIRD_ROW_IN_TRACK_TILE = map['DISPLAY_THIRD_ROW_IN_TRACK_TILE']!;
    DISPLAY_TRACK_NUMBER_IN_ALBUM_PAGE = map['DISPLAY_TRACK_NUMBER_IN_ALBUM_PAGE']!;
    DISPLAY_TRACK_NUMBER_IN_ALBUM_PAGE_SUBTITLE = map['DISPLAY_TRACK_NUMBER_IN_ALBUM_PAGE_SUBTITLE']!;
    DONATE = map['DONATE']!;
    DONE = map['DONE']!;
    ...
    ENABLE_FADE_EFFECT_ON_PLAY_PAUSE = map['ENABLE_FADE_EFFECT_ON_PLAY_PAUSE']!;
    ...
    MOBILE_CAROUSEL_HEIGHT = map['MOBILE_CAROUSEL_HEIGHT']!;
    ...
    NOW_PLAYING_SCREEN_CUSTOMIZATION = map['NOW_PLAYING_SCREEN_CUSTOMIZATION']!;
    ...
    QUEUE_SHEET_MAX_HEIGHT = map['QUEUE_SHEET_MAX_HEIGHT']!;
    QUEUE_SHEET_MIN_HEIGHT = map['QUEUE_SHEET_MIN_HEIGHT']!;
    READ = map['READ']!;
    ...
    RESET_TO_DEFAULT = map['RESET_TO_DEFAULT']!;
    RESTORE = map['RESTORE']!;
    ...
    TITLE = map['TITLE']!;
    TOTAL_TRACKS_DURATION = map['TOTAL_TRACKS_DURATION']!;
    TRACK = map['TRACK']!;
