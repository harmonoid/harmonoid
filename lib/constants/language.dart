  ...
  Future<void> set({LanguageRegion? languageRegion}) async {
    switch (languageRegion) {
      ...
      case LanguageRegion.nlNl: {
        ...
        this.STRING_ABOUT_SUBTITLE                                  = 'Informatie over de app en zijn ontwikkelaars';
        this.STRING_SETTING_SERVER_CHANGE_TITLE                     = 'Server';
        ...
        this.STRING_SETTING_INDEXING_LINEAR_PROGRESS_INDICATOR      = 'NUMBER_STRING / TOTAL_STRING nummers geindexeerd...';
        this.STRING_SETTING_INDEXING_DONE                           = 'Uw muziek collectie is geindexeerd';
