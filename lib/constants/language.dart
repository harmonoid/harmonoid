...
class Language extends Strings with ChangeNotifier {
  ...
  Future<void> set({required LanguageData value}) async {
    ...
    ALBUM_DELETE_DIALOG_BODY = map['ALBUM_DELETE_DIALOG_BODY']!;
    ALBUM_DELETE_DIALOG_HEADER = map['ALBUM_DELETE_DIALOG_HEADER']!;
    ...
    NO_SUBTITLE = map['NO_SUBTITLE']!;
    NO_TITLE = map['NO_TITLE']!;
    ...
    PLAYLIST_DELETE_DIALOG_BODY = map['PLAYLIST_DELETE_DIALOG_BODY']!;
    PLAYLIST_DELETE_DIALOG_HEADER = map['PLAYLIST_DELETE_DIALOG_HEADER']!;
    ...
    SEARCH_NO_RESULTS_SUBTITLE = map['SEARCH_NO_RESULTS_SUBTITLE']!;
    SEARCH_NO_RESULTS_TITLE = map['SEARCH_NO_RESULTS_TITLE']!;
    SEARCH_SUBTITLE = map['SEARCH_SUBTITLE']!;
    SEARCH_TITLE = map['SEARCH_TITLE']!;
    SEE_ALL = map['SEE_ALL']!;
    ...
    TRACK = map['TRACK']!;
    TRACKS = map['TRACKS']!;
    TRACKS_SUBHEADER = map['TRACKS_SUBHEADER']!;
    TRACK_DELETE_DIALOG_BODY = map['TRACK_DELETE_DIALOG_BODY']!;
    TRACK_DELETE_DIALOG_HEADER = map['TRACK_DELETE_DIALOG_HEADER']!;
    TRACK_NUMBER = map['TRACK_NUMBER']!;
    TRACK_PLAYLIST_REMOVE_DIALOG_BODY = map['TRACK_PLAYLIST_REMOVE_DIALOG_BODY']!;
    TYPE = map['TYPE']!;
    UNMUTE = map['UNMUTE']!;
