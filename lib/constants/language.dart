...
class Language extends Strings with ChangeNotifier {
  ...
  Future<void> set({required LanguageRegion languageRegion}) async {
    ...
    this.AUTOMATICALLY_ADD_OTHER_SONGS_TO_NOW_PLAYING_TITLE =
        asset['AUTOMATICALLY_ADD_OTHER_SONGS_TO_NOW_PLAYING_TITLE']!;
    ...
    this.CHANGE_NOW_PLAYING_BAR_COLOR_BASED_ON_MUSIC =
        asset['CHANGE_NOW_PLAYING_BAR_COLOR_BASED_ON_MUSIC']!;
    this.CHANGE_NOW_PLAYING_BAR_COLOR_BASED_ON_MUSIC_TITLE =
        asset['CHANGE_NOW_PLAYING_BAR_COLOR_BASED_ON_MUSIC_TITLE']!;
    ...
    this.COLLECTION_TRACK_PLAYLIST_REMOVE_DIALOG_BODY =
        asset['COLLECTION_TRACK_PLAYLIST_REMOVE_DIALOG_BODY']!;
    ...
    this.INDEXING_ALREADY_GOING_ON_SUBTITLE =
        asset['INDEXING_ALREADY_GOING_ON_SUBTITLE']!;
    this.INDEXING_ALREADY_GOING_ON_TITLE =
        asset['INDEXING_ALREADY_GOING_ON_TITLE']!;
    ...
    this.PLAYLIST_NAME = asset['PLAYLIST_NAME']!;
    ...
    this.SHOW_NOW_PLAYING_AFTER_PLAYING_SUBTITLE =
        asset['SHOW_NOW_PLAYING_AFTER_PLAYING_SUBTITLE']!;
    this.SHOW_TRACK_PROGRESS_ON_TASKBAR =
        asset['SHOW_TRACK_PROGRESS_ON_TASKBAR']!;
    this.SHOW_TRACK_PROGRESS_ON_TASKBAR_SUBTITLE =
        asset['SHOW_TRACK_PROGRESS_ON_TASKBAR_SUBTITLE']!;
    ...
    this.USE_MODERN_NOW_PLAYING_SCREEN =
        asset['USE_MODERN_NOW_PLAYING_SCREEN']!;
    this.USE_THESE_CHARACTERS_TO_SEPARATE_ARTISTS =
        asset['USE_THESE_CHARACTERS_TO_SEPARATE_ARTISTS']!;
