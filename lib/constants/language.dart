  ...
  Future<void> set({LanguageRegion? languageRegion}) async {
    switch (languageRegion) {
      ...
      case LanguageRegion.frFr: {
        ...
        this.STRING_COLLECTION_SEARCH_LABEL                         = 'recherche dans votre collection';
        ...
        this.STRING_COLLECTION_INDEXING_LABEL                       = 'En cours de synchronisation de votre musique local.\nNe fermez pas l\'applicatiopn svp.';
        this.STRING_RECOMMENDATIONS                                 = 'Recommendations';
        this.STRING_YOUTUBE_WELCOME                                 = 'Rechercher une chanson ou son son lien';
        this.STRING_YOUTUBE_NO_RESULTS                              = 'Aucune correspondance trouvée.';
        this.STRING_YOUTUBE_INTERNET_ERROR                          = 'Lire votre musique local, en attendant que vous êtes en ligne.';
        ...
        this.STRING_LAST_COLLECTION_DIRECTORY_REMOVED               = 'Au moins un dosser doit rester dans votre collection.';
        this.STRING_ENABLE_125_SCALING                              = 'Activer la mise en echelle de 125%.';
      }
      break;
