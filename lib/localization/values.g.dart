...
class Values {
  ...
  late String SETTINGS_SECTION_EXPERIMENTAL_SUBTITLE;
  late String SETTINGS_SECTION_EXPERIMENTAL_TITLE;
  late String SETTINGS_SECTION_LANGUAGE_INFO;
  ...
  late String TAG_EDITOR_ERROR_UNKNOWN_AUDIO_FILE;
  late String TAG_EDITOR_ERROR_UNKNOWN_IMAGE_FILE;
  late String TAG_EDITOR_EXPORT_COVER;
  late String TAG_EDITOR_FILL_FROM_INTERNET;
  late String TAG_EDITOR_KEY;
  late String TAG_EDITOR_NO_TAGS_SUBTITLE;
  late String TAG_EDITOR_NO_TAGS_TITLE;
  late String TAG_EDITOR_REMOVE_COVER;
  late String TAG_EDITOR_REMOVE_PROPERTY;
  late String TAG_EDITOR_REVERT_COVER;
  late String TAG_EDITOR_SEPARATORS_INFO;
  late String TAG_EDITOR_SET_COVER;
  late String TAG_EDITOR_UNSAVED_CHANGES_DIALOG_SUBTITLE;
  late String THEME;
