...
class LocalizationBase extends Values {
  ...
  Future<void> set({required LocalizationData value}) async {
    ...
    CROSSFADE = map['CROSSFADE']!;
    CROSSFADE_BETWEEN_TRACKS = map['CROSSFADE_BETWEEN_TRACKS']!;
    CROSSFADE_DURATION = map['CROSSFADE_DURATION']!;
    CROSSFADE_EXCLUSIVE_AUDIO_ERROR = map['CROSSFADE_EXCLUSIVE_AUDIO_ERROR']!;
    ...
    DISPLAY_ARTIST_IMAGES = map['DISPLAY_ARTIST_IMAGES']!;
    ...
    ORDER = map['ORDER']!;
    OTP = map['OTP']!;
    OTP_SEND = map['OTP_SEND']!;
    OTP_SEND_FAILURE = map['OTP_SEND_FAILURE']!;
    OTP_SEND_SUCCESS = map['OTP_SEND_SUCCESS']!;
    OTP_VERIFY = map['OTP_VERIFY']!;
    OTP_VERIFY_FAILURE = map['OTP_VERIFY_FAILURE']!;
    OTP_VERIFY_SUCCESS = map['OTP_VERIFY_SUCCESS']!;
    PAUSE = map['PAUSE']!;
    PAUSED = map['PAUSED']!;
    ...
    REINDEX = map['REINDEX']!;
    REINDEX_REQUIRED_WARNING = map['REINDEX_REQUIRED_WARNING']!;
    ...
    SETTINGS_SECTION_EXPERIMENTAL_SUBTITLE = map['SETTINGS_SECTION_EXPERIMENTAL_SUBTITLE']!;
    SETTINGS_SECTION_EXPERIMENTAL_TITLE = map['SETTINGS_SECTION_EXPERIMENTAL_TITLE']!;
    SETTINGS_SECTION_LANGUAGE_INFO = map['SETTINGS_SECTION_LANGUAGE_INFO']!;
    ...
    SETTINGS_SECTION_PLUS_SUBTITLE = map['SETTINGS_SECTION_PLUS_SUBTITLE']!;
    ...
    SPEED = map['SPEED']!;
    START = map['START']!;
    START_MIX_AFTER_ENDING = map['START_MIX_AFTER_ENDING']!;
    STEREO = map['STEREO']!;
    SUBSCRIPTION_EXPIRED_SUBTITLE = map['SUBSCRIPTION_EXPIRED_SUBTITLE']!;
    SUBSCRIPTION_EXPIRED_TITLE = map['SUBSCRIPTION_EXPIRED_TITLE']!;
    TAG_EDITOR = map['TAG_EDITOR']!;
    TAG_EDITOR_ADD_PROPERTY = map['TAG_EDITOR_ADD_PROPERTY']!;
    TAG_EDITOR_ERROR_SAVE = map['TAG_EDITOR_ERROR_SAVE']!;
    TAG_EDITOR_ERROR_SET_COVER = map['TAG_EDITOR_ERROR_SET_COVER']!;
    TAG_EDITOR_ERROR_UNKNOWN_AUDIO_FILE = map['TAG_EDITOR_ERROR_UNKNOWN_AUDIO_FILE']!;
    TAG_EDITOR_ERROR_UNKNOWN_IMAGE_FILE = map['TAG_EDITOR_ERROR_UNKNOWN_IMAGE_FILE']!;
    TAG_EDITOR_EXPORT_COVER = map['TAG_EDITOR_EXPORT_COVER']!;
    TAG_EDITOR_FILL_FROM_INTERNET = map['TAG_EDITOR_FILL_FROM_INTERNET']!;
    TAG_EDITOR_KEY = map['TAG_EDITOR_KEY']!;
    TAG_EDITOR_NO_TAGS_SUBTITLE = map['TAG_EDITOR_NO_TAGS_SUBTITLE']!;
    TAG_EDITOR_NO_TAGS_TITLE = map['TAG_EDITOR_NO_TAGS_TITLE']!;
    TAG_EDITOR_REMOVE_COVER = map['TAG_EDITOR_REMOVE_COVER']!;
    TAG_EDITOR_REMOVE_PROPERTY = map['TAG_EDITOR_REMOVE_PROPERTY']!;
    TAG_EDITOR_REVERT_COVER = map['TAG_EDITOR_REVERT_COVER']!;
    TAG_EDITOR_SEPARATORS_INFO = map['TAG_EDITOR_SEPARATORS_INFO']!;
    TAG_EDITOR_SET_COVER = map['TAG_EDITOR_SET_COVER']!;
    TAG_EDITOR_UNSAVED_CHANGES_DIALOG_SUBTITLE = map['TAG_EDITOR_UNSAVED_CHANGES_DIALOG_SUBTITLE']!;
    THEME = map['THEME']!;
