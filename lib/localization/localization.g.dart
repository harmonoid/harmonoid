...
class LocalizationBase extends Values {
  ...
  Future<void> set({required LocalizationData value}) async {
    ...
    MEDIA_LIBRARY_MISSING_FOLDERS_SUBTITLE = map['MEDIA_LIBRARY_MISSING_FOLDERS_SUBTITLE']!;
    MEDIA_LIBRARY_MISSING_FOLDERS_TITLE = map['MEDIA_LIBRARY_MISSING_FOLDERS_TITLE']!;
