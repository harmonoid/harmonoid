...
mixin _$PlaybackState {
 ...
 int get index; List<Playable> get playables; double get rate; double get pitch; double get volume; bool get shuffle; Loop get loop; ReplayGain get replayGain; double get replayGainPreamp; Duration get crossfadeDuration;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,index,const DeepCollectionEquality().hash(playables),rate,pitch,volume,shuffle,loop,replayGain,replayGainPreamp,crossfadeDuration);

@override
String toString() {
  return 'PlaybackState(index: $index, playables: $playables, rate: $rate, pitch: $pitch, volume: $volume, shuffle: $shuffle, loop: $loop, replayGain: $replayGain, replayGainPreamp: $replayGainPreamp, crossfadeDuration: $crossfadeDuration)';
}
...
@useResult
$Res call({
 int index, List<Playable> playables, double rate, double pitch, double volume, bool shuffle, Loop loop, ReplayGain replayGain, double replayGainPreamp, Duration crossfadeDuration
});
...
/// Create a copy of PlaybackState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? index = null,Object? playables = null,Object? rate = null,Object? pitch = null,Object? volume = null,Object? shuffle = null,Object? loop = null,Object? replayGain = null,Object? replayGainPreamp = null,Object? crossfadeDuration = null,}) {
...
as Loop,replayGain: null == replayGain ? _self.replayGain : replayGain // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int index,  List<Playable> playables,  double rate,  double pitch,  double volume,  bool shuffle,  Loop loop,  ReplayGain replayGain,  double replayGainPreamp,  Duration crossfadeDuration)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlaybackState() when $default != null:
return $default(_that.index,_that.playables,_that.rate,_that.pitch,_that.volume,_that.shuffle,_that.loop,_that.replayGain,_that.replayGainPreamp,_that.crossfadeDuration);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int index,  List<Playable> playables,  double rate,  double pitch,  double volume,  bool shuffle,  Loop loop,  ReplayGain replayGain,  double replayGainPreamp,  Duration crossfadeDuration)  $default,) {final _that = this;
switch (_that) {
case _PlaybackState():
return $default(_that.index,_that.playables,_that.rate,_that.pitch,_that.volume,_that.shuffle,_that.loop,_that.replayGain,_that.replayGainPreamp,_that.crossfadeDuration);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int index,  List<Playable> playables,  double rate,  double pitch,  double volume,  bool shuffle,  Loop loop,  ReplayGain replayGain,  double replayGainPreamp,  Duration crossfadeDuration)?  $default,) {final _that = this;
switch (_that) {
case _PlaybackState() when $default != null:
return $default(_that.index,_that.playables,_that.rate,_that.pitch,_that.volume,_that.shuffle,_that.loop,_that.replayGain,_that.replayGainPreamp,_that.crossfadeDuration);case _:
  return null;
...
class _PlaybackState implements PlaybackState {
  const _PlaybackState({required this.index, required final  List<Playable> playables, required this.rate, required this.pitch, required this.volume, required this.shuffle, required this.loop, required this.replayGain, required this.replayGainPreamp, required this.crossfadeDuration}): _playables = playables;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,index,const DeepCollectionEquality().hash(_playables),rate,pitch,volume,shuffle,loop,replayGain,replayGainPreamp,crossfadeDuration);
...
/// Create a copy of PlaybackState
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? index = null,Object? playables = null,Object? rate = null,Object? pitch = null,Object? volume = null,Object? shuffle = null,Object? loop = null,Object? replayGain = null,Object? replayGainPreamp = null,Object? crossfadeDuration = null,}) {
