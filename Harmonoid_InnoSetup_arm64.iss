...
OutputBaseFilename=harmonoid-windows-arm64-setup
Compression=lzma
...
[Files]
Source: "build/windows/arm64/runner/Release/{#MyAppExeName}"; DestDir: "{app}"; Flags: ignoreversion
